...
public class JavaWebServerService extends Service {

    public static JavaWebServerService mySelf = null;
    ...
    public void onCreate() {
        super.onCreate();
        sws = new JavaWebServer(this);
        sws.start();
        createNotification();
        mySelf = this;

        Toast.makeText(getApplicationContext(), "Web Server Started on port 4300",
