...
public class JavaWebServer {
    ...
    private static final String TAG = "LauncherWebServer";

    // File name of the image used in server response
    private static final String EMBEDDED_IMAGE_FILENAME = "ic_launcher.png";

    private ServerSocketFactory sssf;
    ...
    protected void start() {
        ...
        new Thread(new Runnable() {
            ...
            @Override
            public void run() {
                Log.d(TAG, "Web Server is starting up on port 4300");
                try {
                    // Create the secure server socket
                    sss = (ServerSocket) sssf.createServerSocket(4300);
                } catch (Exception e) {
                    Log.e(TAG, "Error: " + e);
                    return;
                }
                ...
                while (isRunning) {
                    try {
                        ...
                        out.println("Server: Chrome Launcher Server");
